...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_fresh_books_api_fresh_books_api__ = __webpack_require__(195);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, freshBooksApiProvider) {
        this.navCtrl = navCtrl;
        this.freshBooksApiProvider = freshBooksApiProvider;
        freshBooksApiProvider.getInvoices().then(function () {
            debugger;
        });
    }
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/mullahkhan/Desktop/test/freshBooks/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <h3>Ionic Menu Starter</h3>\n\n  <p>\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will show you the way.\n  </p>\n\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n</ion-content>\n'/*ion-inline-end:"/Users/mullahkhan/Desktop/test/freshBooks/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_fresh_books_api_fresh_books_api__["a" /* FreshBooksApiProvider */]])
    ], HomePage);
    return HomePage;
}());
...
var FreshBooksApiProvider = /** @class */ (function () {
    function FreshBooksApiProvider(http) {
        var _this = this;
        this.http = http;
        this.getInvoices = function () {
            return new Promise(function (resolve) {
                ...
                */
                var url = "https://api.freshbooks.com/accounting/account/K5Vxa/invoices/invoices?search%5Bnotes%5D=Wednesday";
                var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
                headers.append("Content-Type", "text/plain");
                headers.append("Api-Version", "alpha");
                headers.append("Authorization", "Bearer 8763331008cf21cdf7a6ad3a36753734e599ff96d4b80544446da4033191dd00");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_fresh_books_api_fresh_books_api__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_http__ = __webpack_require__(271);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
